...
# WORKER. Compresses and archives logs/ledgers after session end into /backups/.
# Only launched by main.py. All paths resolved via path_resolver.py. Supports TEST_MODE separation if needed.
